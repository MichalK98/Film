        ...
        <div class="movieTimeContainer">
            ...
            <div class="movieGridContainer">
                <div class="movieContainer" style="background-image: url('https://m.media-amazon.com/images/M/MV5BMjU1ODM1MzYxN15BMl5BanBnXkFtZTgwOTA4NDE2ODE@._V1_.jpg'); ">
                    ...
                    <div class="corner">
                        <router-link to="/x-men-about" class="nav-link"><span>More</span></router-link>
                    </div>
                </div>
                <div class="movieContainer" style="background-image: url('https://m.media-amazon.com/images/M/MV5BMjU1ODM1MzYxN15BMl5BanBnXkFtZTgwOTA4NDE2ODE@._V1_.jpg'); ">
                    <h2 class="movieTitel">Titel</h2>
                    <div class="corner">
                        <router-link to="/call-me-by-your-name-about" class="nav-link"><span>More</span></router-link>
                    </div>
                </div>
                <div class="movieContainer" style="background-image: url('https://m.media-amazon.com/images/M/MV5BMjU1ODM1MzYxN15BMl5BanBnXkFtZTgwOTA4NDE2ODE@._V1_.jpg'); ">
                    <h2 class="movieTitel">Titel</h2>
                    <div class="corner">
                        <router-link to="/king-kong-about" class="nav-link"><span>More</span></router-link>
                    </div>
                </div>
            </div>
        </div>
